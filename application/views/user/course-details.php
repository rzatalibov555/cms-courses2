                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="course__wrapper">
                        ...
                        <div class="course__meta-2 d-sm-flex mb-30">
                           <div class="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                              ...
                              <div class="course__teacher-info-3">
                                 <h5>Teacher</h5>
                                 <p><a href="#"><?php echo $single_course['t_title']; ?></a></p>
                              </div>
                           </div>
                        ...
                        <div class="course__img w-img mb-30">
                           <img src="<?php echo base_url('upload/courses/'.$single_course['img']); ?>" alt="">
                        </div>
                                                     ...
                                                     <div class="accordion-body">
                                                         ...
                                                         <div class="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                                                             <div class="course__curriculum-info">
                                                                 ...
                                                                 <h3 class="textP">  <?php echo $programs_item['prog_descr_az']; ?></h3>
                                                             </div>
                           ...
                           <div class="row">
                              <div class="col-xxl-12">
                                 <div class="section__title-wrapper mb-40">
                                    <h2 class="section__title">Related <span class="yellow-bg yellow-bg-big">Course<img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg.png" alt=""></span></h2>
                                       ...
                                       <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                          ...
                                          <div class="course__content">
                                             ...
                                             <div class="course__teacher d-flex align-items-center">
                                                ...
                                                <h6><a href="instructor-details.php">Jim Séchen</a></h6>
                                             </div>
                                          </div>
                                       ...
                                       <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                          ...
                                          <div class="course__content">
                                             ...
                                             <div class="course__teacher d-flex align-items-center">
                                                ...
                                                <h6><a href="instructor-details.php">Barry Tone</a></h6>
                                             </div>
                                          </div>
                                          <div class="course__more d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                          ...
                                          <div class="course__content">
                                             ...
                                             <div class="course__teacher d-flex align-items-center">
                                                ...
                                                <h6><a href="instructor-details.php">Elon Gated</a></h6>
                                             </div>
                                          </div>
                                          <div class="course__more d-flex justify-content-between align-items-center">
                                             <div class="course__status d-flex align-items-center">
                                       ...
                                       <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                                          ...
                                          <div class="course__content">
                                             ...
                                             <div class="course__teacher d-flex align-items-center">
                                                ...
                                                <h6><a href="instructor-details.php">Eleanor Fant</a></h6>
                                             </div>
                                          </div>
                                          <div class="course__more d-flex justify-content-between align-items-center">
                                             <div class="course__status d-flex align-items-center">
                              ...
                              <ul>
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-30">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="#">
                                             <img src="<?php echo base_url('assets/user/'); ?>assets/img/course/sm/course-sm-1.jpg" alt="">
                                          </a>
                                       </div>
                                 ...
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-30">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="#">
                                             <img src="<?php echo base_url('assets/user/'); ?>assets/img/course/sm/course-sm-2.jpg" alt="">
                                          </a>
                                       </div>
                                       <div class="course__sm-content">
                                          <div class="course__sm-rating">
                                 ...
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-10">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="#">
                                             <img src="<?php echo base_url('assets/user/'); ?>assets/img/course/sm/course-sm-3.jpg" alt="">
                                          </a>
                                       </div>
                                       <div class="course__sm-content">
                                          <div class="course__sm-rating">
